...
import { AcctdatComponent } from './acctdat.component';

describe('Component Tests', () => {
  describe('Acctdat Management Component', () => {
    let comp: AcctdatComponent;
    let fixture: ComponentFixture<AcctdatComponent>;
    let service: AcctdatService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [AcctdatComponent],
      })
        .overrideTemplate(AcctdatComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(AcctdatComponent);
